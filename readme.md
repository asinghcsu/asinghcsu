...
- **Agentic AI** - Agent systems, interoperability protocols, and the Agentic Web
- **LLM Applications** - Healthcare, text-to-SQL, sustainability, and prompt engineering
- **AI Ethics & Fairness** - Bias detection and mitigation in AI systems
- **Human-Robot Interaction** - Gesture recognition and conversational AI

## 🎓 Education & Recognition

- **Awards & Honors**: Best Paper Awards, Best Presenter Awards, Researcher Finalist (Women in AI)
- **Teaching**: Courses at Cleveland State University and Kent State University
- **Publications**: 20+ papers in journals and conferences
- **Service**: ACM-W, Women in AI, academic committees

## 🌟 Beyond Research

- **Mentorship**: Guiding students through research projects and career development
- **Academic Service**: Leading student organizations and committees
- **Community**: Active in AI education and diversity initiatives
- **Learning**: Continuously exploring new AI technologies and methodologies

I believe in the power of AI to solve real-world problems while maintaining ethical standards and accessibility. My work bridges cutting-edge research with practical education, ensuring the next generation is well-prepared for the AI-driven future.
...
[![Google Scholar](https://img.shields.io/badge/Google%20Scholar-4285F4?style=for-the-badge&logo=googlescholar&logoColor=white)](https://scholar.google.com/citations?user=az0wOaoAAAAJ)
[![ResearchGate](https://img.shields.io/badge/ResearchGate-00CCBB?style=for-the-badge&logo=researchgate&logoColor=white)](https://www.researchgate.net/profile/Aditi_Singh31)
[![X (Twitter)](https://img.shields.io/badge/X-000000?style=for-the-badge&logo=x&logoColor=white)](https://x.com/_prof__csu?s=11&t=4tbHKFwvi3avKn5gISXAGw)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:a.singh22@csuohio.edu)

## 💡 Support My Work!

You can support my research and educational initiatives by:
- ⭐ Starring my repositories
- 📖 Reading and citing my publications
- 🤝 Connecting and collaborating on AI projects
- 📧 Reaching out for potential collaborations

---

*"Advancing AI through research, education, and ethical innovation"* 🚀
